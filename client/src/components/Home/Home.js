    ...
    <div className="home-page-container">
        ...
        <div>
          ...
          <div className='home-page-first-div'>
            ...
            <h1>ONLINE EXAMS</h1>
            <p>Exam.net equips you with all the power and function you need to securely create, conduct and mark exams for your students.
            Create and conduct your first exam in less than an hour</p>
            <div>
              <button className='home-page-register-btn'>Register Now</button>
            </div>
            </div>
        ...
        <div className="home-page-third-div-container">
          <div className="home-page-third-div-header">
            <p>Trusted by Over <b>270 000</b> teachers across the world</p>
          </div>
        ...
        <div className="home-page-fourth-container">
          <div className="home-page-fourth-con-header">
            <h2>But I teach <span>History . . .</span> will <span>Exam.net</span> work for me and my students?</h2>
          </div>
        ...
        <div className="home-page-fifth-container">
            ...
            <div className="home-page-fifth-container-button">
              <button>Start the Test's</button>
            </div>  
        </div>
